...
<head>
    ...
    <link rel="stylesheet" href="src/css/main9.css">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <a class="navbar-brand" href="">
                    <img src="src/img/banana.jpg" alt="Logo" width="30" height="30" class="d-inline-block align-top" style="border-radius: 50px;">
                    Banana is Yellow
                </a>
                <div class="timer">
                    <div id="time"></div>
