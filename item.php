...
?>
            ...
            <div class="text-left">
                <div class="container">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <button class="btn btn-warning btn-rounded" data-bs-toggle="modal" data-bs-target="#addItemModal">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form id="addItemForm" action="item-add.php" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="medicinename" class="control-label">Product Name</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="barcode" id="barcode" class="form-control rounded-0" required>
                                    </div>
    ...
    <script>
        function openEditModal(itemId, brand, category, type, description, unit, price, barcode) {
