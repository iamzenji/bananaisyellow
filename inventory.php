                                    ...
                                    <tr>
                                        <td colspan="13">
                                            <div class="container">
                                                <div class="row align-items-center">
                                                    <div class="col-md-6">
                                                        <button id="exportLogs" class="btn btn-outline-warning" style="height: 40px;">Export Inventory</button>
                                                    </div>
                                                    <div class="align-middle col-md-6">
                                                        <div class="d-flex justify-content-end">
                                                            <button type="button" class="btn btn-outline-warning" id="toggleSearch">
                                        ...
                                        <tr class="edit-row align-middle text-center" data-toggle="modal" data-target="#editModal_<?php echo $row['inventory_id']; ?>">
                                            ...
                                            <td>
                                                <form onsubmit="return confirmRequestOrder(event)">
                                                    <button type="submit" class="btn btn-sm btn-outline-warning rounded-pill" onclick="stopPropagation(event);">Request Order</button>
                                                </form>
                                            </td>
                                        </tr>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="button" class="btn btn-warning" onclick="submitRequestOrder()">Confirm</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="update_inventory.php" method="post">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="unit_cost" name="unit_cost" value="<?php echo $row['unit_cost']; ?>">
                                                            </div>
                                                            <div class="form-group">
