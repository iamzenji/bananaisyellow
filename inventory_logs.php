    ...
    <div class="container mt-4">
        ...
        <div class="container row mb-1">
            ...
            <div class="dropdown-logs">
                <button class="dropbtn btn btn-outline-warning dropdown-toggle"><i class="lni lni-lineicons-symbol"></i> Reasons</button>
                    ...
                    <td colspan="6">
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <button id="exportLogs" class="btn btn-outline-warning" style="height: 40px;">Export Logs</button>
                                </div>
                                <div class="align-middle col-md-6">
                                    <div class="d-flex justify-content-end">
                                        <button type="button" class="btn btn-outline-warning" id="toggleSearch" style="margin-right: 10px;">
                                        ...
                                        <button class="btn btn-outline-warning dropdown-toggle" type="button" id="filterByDateBtn">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-warning" id="applyDateFilter">Apply</button>
                </div>
            </div>
        </div>
    </div>
