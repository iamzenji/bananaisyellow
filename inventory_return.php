                    ...
                    <td colspan="8">
                        <div class="container">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <button id="addReturnButton" class="btn btn-outline-warning" style="height: 40px;">Add Return Product</button>
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-warning" name="addReturn">Add Return</button>
                </div>
                </form>
            </div>
        </div>
