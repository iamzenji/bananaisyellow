    ...
    <div class="main-content"><?php include('sidebar.php'); ?>
        <div class="">
            ...
            <div style="margin: 1rem; justify-content: space-evenly;" class="row">
                <button onclick="location.href='posample.php'" type="button" class="rep btn btn-outline-warning m-4" style="width: 20vw; height: 20vh;">
                    <div class="card-body">
                        <h3><i class='bx bxs-basket bx-tada bx-rotate-270' style=font-size:60px></i> POS</h3>
                    </div>
                </button>
                <button onclick="location.href='map.php'" type="button" class="rep btn btn-outline-warning m-4" style="width: 20vw; height: 20vh;">
                    <div class="card-body">
                        <h3><i class='bx bxs-map-alt bx-tada bx-rotate-270' style=font-size:60px></i> Item Mapping</h3>
                    </div>
                </button>
                <button onclick="location.href='records.php'" type="button" class="rep btn btn-outline-warning m-4" style="width: 20vw; height: 20vh;">
                    <div class="card-body">
                ...
                <!-- sales -->
                <button onclick="location.href='sales.php'" type="button" class="rep btn btn-outline-warning m-4" style="width: 20vw; height: 20vh;">
                    <div class="card-body">
                        <?php
                        $cashier = $_SESSION['id'];
                ...
                <!-- discounts -->
                <button onclick="location.href='disc.php'" type="button" class="rep btn btn-outline-warning m-4 " style="width: 20vw; height: 20vh;">
                    <div class="card-body">
                        <?php
                        $cashier = $_SESSION['id'];
                ...
                <!-- item sales -->
                <button onclick="location.href='item.php'" type="button" class="rep btn btn-outline-warning m-4" style="width: 20vw; height: 20vh;">
                    <div class="card-body">
                        <?php
                        $cashier = $_SESSION['id'];
                ...
                <!-- refunded -->
                <button onclick="location.href='refunded.php'" type="button" class="rep btn btn-outline-warning m-4" style="width: 20vw; height: 20vh;">
                    <div class="card-body">
                        <?php
                        $cashier = $_SESSION['id'];
                        $sql = "SELECT SUM(qty) AS total FROM mebalik ;";
                        $result = $connection->query($sql);
                        ...
                        while ($row = $result->fetch_assoc()) {
                        ?>
                            <h3><i class='bx bxs-file-export bx-tada' style='font-size:60px;'></i>Refunded Item</h3>
                            <h2 class="card-title"><?php echo number_format($row['total']); ?></h2>
                ...
                <!-- cancel item -->
                <button onclick="location.href='discard.php'" type="button" class="rep btn btn-outline-warning m-4" style="width: 20vw; height: 20vh;">
                    <div class="card-body">
                        <?php
                        $cashier = $_SESSION['id'];
