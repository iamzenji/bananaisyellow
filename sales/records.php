                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><button id="view" value="<?php echo "$row[transact_no]"; ?>" class="btn btn-sm bg-primary-subtle"><i class="bi bi-eye-fill"></i></button>
                                <button id="return" value="<?php echo "$row[transact_no]"; ?>" class="btn btn-sm bg-danger-subtle"><i class="bi bi-arrow-return-left"></i></button></td>
                            </tr>
