	...
	<div class="main-content"><?php include('sidebar.php'); ?>
		...
		<div>
			<div class="header">
				...
				<h1><i style="margin: 1rem;" class='bx bx-cart-download bx-tada'></i>Canceled Item's</h1>
			</div>
						...
						<div style="padding: 3rem 0 0 0;">
							<div class="item-map">
								<table class="table table-sm table-striped table-hover mapping" style="width: 100%;">
									...
									<tbody>
										<?php
										$query =  "SELECT * FROM `meremove` JOIN inventory ON inventory.inventory_id = meremove.item_id WHERE cashier_id = $cashier;";
